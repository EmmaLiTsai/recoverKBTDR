...
# Default csv files exported from ImageJ can be tidied to this format using the tidy_raw_timedots() function and tidy_raw_trace() function. 
```
...
plot(df[1000:18000, c(1,8)],xlab = "Date Time", ylab = "Depth (m)", type = "l", main = "Depth Transformation")
```
...
plot(df[1000:18000, c(1,8)], xlab = "Date Time", ylab = "Depth (m)", type = "l", main = "Depth Transformation", lwd = 3)
