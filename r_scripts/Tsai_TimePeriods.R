################################################################################
# Author: EmmaLi Tsai
# Topic: Full Trace Recovery 
# Date: 2021-1-18
################################################################################
# This script is broken up into different objectives: 
# 
#   Removing the arc (row 74)
#   Spline smoothing (row 98)
#   Adding time dots (row 195)
#   Transforming x-axis into time (row 277)
#   Centering the scan (row 400)
#   Adding dates and times (row 561)
...
# working directory should be sample_data folder 

# reading in trace data 
